...
myApp.controller("BackgroundController", [function() {

  const UNITS_PER_WINDOW = 30;        // 10 is too big, 100 is too small
              ...
              for(var n = 0; n < 2; n++) {
                  ...
                  if ( rando === 0 ) {
                      ...
                      if ( n === 0 ) {
                          ...
                          polygon.setAttribute('points', topLeftX + ',' +
                            topLeftY + ' ' + bottomLeftX + ',' + bottomLeftY +
                      ...
                      if ( n === 0 ) {
                          ...
                          polygon.point2 = i + 1;
                          polygon.point3 = i + numPointsX + 1;
                          polygon.setAttribute('points', bottomLeftX + ',' +
                            bottomLeftY + ' ' + topRightX + ',' + topRightY +
                            ' ' + bottomRightX + ',' + bottomRightY);
                      }
                  }
                  var colors = [
                    "rgba(0, 160, 255, " + ( RANDOM_ALPHA || (Math.random()) ) + ")",
                    "rgba(0, 144, 240, " + ( RANDOM_ALPHA || (Math.random()) ) + ")",
                    "rgba(0, 144, 240, " + ( RANDOM_ALPHA || (Math.random()) ) + ")",
                    "rgba(0, 144, 255, " + ( RANDOM_ALPHA || (Math.random()) ) + ")",
                    "rgba(0, 128, 192, " + ( RANDOM_ALPHA || (Math.random()) ) + ")",
                    "rgba(64, 36, 48, " + ( RANDOM_ALPHA || (Math.random()) ) + ")",
                    "rgba(48, 24, 20, " + ( RANDOM_ALPHA || (Math.random()) ) + ")",
                    "rgba(104, 16, 16, " + ( RANDOM_ALPHA || (Math.random()) ) + ")",
                    "rgba(192, 92, 60, " + ( RANDOM_ALPHA || (Math.random()) ) + ")",
                    "rgba(200, 160, 96, " + ( RANDOM_ALPHA || (Math.random()) ) + ")"
                  ];
  ...
  function refresh() {
      ...
      for(var i = 0; i < document.querySelector('#bg svg').childNodes.length; i++) {
          ...
          animate.setAttribute('to', points[polygon.point1].x + ',' +
            points[polygon.point1].y + ' ' + points[polygon.point2].x + ',' +
            points[polygon.point2].y + ' ' + points[polygon.point3].x + ',' +
